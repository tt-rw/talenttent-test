...
| **TT-62 (deel 2)** | "Geef me een seintje zodra er een drummer bijkomt" | **Gebouwd 26-09-2026 (vervolg 4), samen met TT-295: "Mail me als er iemand bijkomt" staat onder elk resultaat op het tabblad Muzikant, en bovenaan na verruimen. Laag 2 geslaagd, zie Laatste update.** **Uitzondering vastgelegd 12-09-2026 (besluit Ronald, TT-257):** het automatisch verruimen van deel 1 geldt **niet** als er een naam in het zoekveld staat. Wie op naam zoekt, zoekt één bepaalde persoon; iemand twee provincies verderop is dan geen beter antwoord dan geen antwoord. Zie huisstijl §17. **Deel 1 is gebouwd 11-09-2026** (automatisch verruimen, zie Deel 3). Deel 2 maakt van een dood einde een afspraak die het systeem bewaakt in plaats van de gebruiker. Leunt op dezelfde verzendweg als TT-01 en kan dus niet eerder |
